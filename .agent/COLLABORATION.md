...
1. Read STATE.md, PLAN.md and, when available locally, recent AGENT_LOG.jsonl entries at start.
...
6. Push versioned code and control-plane files; local logs, quality output, and temporary evidence are regenerated per environment.
